    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'admin'), (2, 'farmer'), (3, 'agri_expert'), (4, 'service_provider')], default=2)),
                ('county', models.CharField(blank=True, max_length=100, null=True)),
                ('farm_location', models.CharField(blank=True, max_length=100, null=True)),
